                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                            {leadership.map((m, i) => (
                                <motion.div
                                    key={m.name}
                                    variants={fadeInUp}
                                    className="bg-white rounded-[14px] ring-1 ring-slate-900/5 p-6 sm:p-8 flex gap-5 items-start transition-all duration-[300ms] ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-[3px] group relative overflow-hidden"
