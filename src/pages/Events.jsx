...
const PastEventCard = ({ event, onClick }) => (
    <motion.div
        ...
        onClick={onClick}
        className="group relative bg-white rounded-[14px] ring-1 ring-slate-900/5 p-8 cursor-pointer transition-all duration-[300ms] ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-[3px] overflow-hidden flex flex-col md:flex-row md:items-center gap-6"
        style={{ boxShadow: '0 1px 2px rgba(0,0,0,0.04),0 8px 24px rgba(0,0,0,0.04)' }}
    >
                        ...
                        <div>
                            ...
                            {upcomingEvents.length > 0 ? (
                                ...
                                <motion.div
                                    ...
                                    className="bg-slate-900 grid-texture-dark rounded-[14px] ring-1 ring-slate-900/5 p-12 flex flex-col md:flex-row md:items-center gap-8"
                                    style={{ boxShadow: '0 1px 2px rgba(0,0,0,0.04),0 8px 24px rgba(0,0,0,0.04)' }}
                                >
